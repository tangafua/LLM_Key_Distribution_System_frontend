<template>
    <el-table :data="userCards" @selection-change="handleCardSelection">
        ...
        <el-table-column prop="used_balance" label="已用额度"></el-table-column>
        <el-table-column prop="left_balance" label="剩余额度"></el-table-column>
    </el-table>
  </template>
